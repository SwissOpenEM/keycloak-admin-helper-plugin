...
public class RealmAdminResourceOverride extends RealmAdminResource {
    public RealmAdminResourceOverride(KeycloakSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
        super(session, auth, adminEvent);
    }
//    protected static final Logger logger = Logger.getLogger(RealmAdminResourceOverride.class);
//
...
//        } catch (Exception e) {
//            logger.error(e.getMessage(), e);
//            throw ErrorResponse.error("Failed to update realm", Status.INTERNAL_SERVER_ERROR);
//        }
//    }
//
//    /**
...
//    }
    ...
    public UsersResource users() {
        return new UsersResourceOverride(session, auth, adminEvent);
    }
//
//    @NoCache
//    @GET
...
//                throw ErrorResponse.error("Logged in user does not have an e-mail.", Status.INTERNAL_SERVER_ERROR);
//            }
...
//            throw ErrorResponse.error("Failed to send email", Status.INTERNAL_SERVER_ERROR);
//        }
//
//        return Response.noContent().build();
//    }
