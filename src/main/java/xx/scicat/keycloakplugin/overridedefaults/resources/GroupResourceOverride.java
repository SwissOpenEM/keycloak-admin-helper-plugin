...
public class GroupResourceOverride extends GroupResource {
    ...
    public GroupResourceOverride(RealmModel realm, GroupModel group, KeycloakSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
        this.realm = realm;
    ...
    public Response updateGroup(GroupRepresentation rep) {
       new CustomGroupAuth( this.auth.groups()).requireManage(group);
        ...
        try {
            ...
            if (rep.getId() != null) {
                ...
                URI uri = session.getContext().getUri().getBaseUriBuilder()
                        ...
                        .path(GroupsResourceOverride.class, "getGroupById")
