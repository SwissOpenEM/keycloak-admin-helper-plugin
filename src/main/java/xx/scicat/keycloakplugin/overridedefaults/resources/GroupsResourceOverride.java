...
public class GroupsResourceOverride extends GroupsResource {
    public GroupsResourceOverride(RealmModel realm, KeycloakSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
...
//    }
    ...
    public GroupResource getGroupById(@PathParam("group-id") String id) {
        ...
        return new GroupResourceOverride(realm, group, session, this.auth, adminEvent);
    }
//
//    /**
...
//            throw ErrorResponse.error("Group name is missing", Status.BAD_REQUEST);
//        }
//
//        try {
//            if (rep.getId() != null) {
