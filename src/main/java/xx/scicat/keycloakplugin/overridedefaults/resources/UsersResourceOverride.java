...
public class UsersResourceOverride extends UsersResource {
    public UsersResourceOverride(KeycloakSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
        super(session, auth, adminEvent);
        this.auth=auth;
        this.adminEvent=adminEvent;
    }
//
//    private static final Logger logger = Logger.getLogger(UsersResourceOverride.class);
...
//    }
    ...
    public UserResource user(final @PathParam("user-id") String id) {
        ...
        return new UserResourceOverride(session, user, auth, adminEvent);
    }
//
//    /**
//     * Get users
